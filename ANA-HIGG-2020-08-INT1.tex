...
%\clearpage
\input{tex/Detector.tex}
\clearpage
\input{tex/MonteCarlo.tex}
\clearpage
%%\input{tex/Selection.tex}
\input{tex/selection_new.tex}
\clearpage
\input{tex/categorization_new.tex}
\clearpage
%%\input{tex/Modelling.tex}
\input{tex/signal_model.tex}
\clearpage
\input{tex/background.tex}
\clearpage
\input{tex/Systematic.tex}
\clearpage
\input{tex/Fitting.tex}
\clearpage
...
\input{tex/appendices/App_BrResult.tex}
%\clearpage
\input{tex/appendices/App_NewCate.tex}
%\clearpage
\input{tex/appendices/App_BinningOpt.tex}
%\clearpage
\input{tex/appendices/App_2x2DSB.tex}
%\clearpage
\input{tex/appendices/App_SStest.tex}
%\clearpage
\input{tex/appendices/App_2Dfit.tex}
%-------------------------------------------------------------------------------
